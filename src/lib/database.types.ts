...
export type Database = {
  public: {
    Tables: {
      ...
      courses: {
        Row: { accent: string | null; category: string | null; cover_url: string | null; created_at: string; created_by: string | null; description: string | null; icon: string | null; id: string; institution_id: string; instructor_id: string | null; level: string | null; price_cents: number; published_at: string | null; rating: number | null; status: string; subtitle: string | null; title: string }
