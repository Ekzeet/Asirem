      ...
      <section style={{ ...wrap, padding: 'clamp(44px,6vw,76px) clamp(20px,5vw,64px) clamp(48px,7vw,88px)', display: 'grid', gridTemplateColumns: 'minmax(0,1.05fr) minmax(0,.95fr)', gap: 'clamp(32px,5vw,72px)' }} className="grid-2">
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <InfoRow label="Email" value="info@asiremacademy.com" last icon={<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="m3 7 9 6 9-6" /></svg>} />
          </div>
        </div>
