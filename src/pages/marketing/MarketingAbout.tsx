...
const team = [
  { name: 'Jean Rollin Deshommes', role: 'CEO · Account Executive · Licensed Financial Professional · Tax Professional & Instructor', pos: 'center 6%' },
  { name: 'Pierre Bertrand', role: 'Co-Founder · Lead Instructor · Tax Professional', pos: 'center 20%' },
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 'clamp(24px,4vw,48px)' }} className="grid-3">
          {team.map((m, i) => (
            <div key={m.name} style={{ textAlign: 'center' }}>
              <figure className="blueprint" style={{ margin: '0 auto 18px', width: 168, height: i === 0 ? 226 : 200, overflow: 'hidden', background: 'var(--color-accent-100)' }}>
